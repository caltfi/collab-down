...
if($session_username == $username && $session_username == $admin){
    ...
    <form action="inc/approve_section.inc.php" method="post" class="d-flex justify-content-center align-items-center">
        <input type="hidden" name="doc_id" value="<?php echo $doc_id ?>">
        <input type="hidden" name="file_id" value="<?php echo $file_id ?>">
    ...
    <form action="inc/flag_section.inc.php" method="post" class="d-flex justify-content-center align-items-center">
        ...
        <input type="hidden" name="file_id" value="<?php echo $file_id ?>">
        <input type="hidden" name="admin" value="<?php echo $admin ?>">
        <button type="submit" name="flag-submit" class="btn btn-outline-dark d-flex justify-content-center align-items-center w-100">
