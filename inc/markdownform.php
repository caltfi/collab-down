    ...
    <div class="col-6">
        <form action="index.php" method="post">
            <div class="row">
                ...
                <textarea name="mdContent" class="form-control" id="mdContent" cols="30" rows="15" placeholder="Markdown Text Here"><?php echo file_get_contents("mdfiles/test.md"); ?></textarea>
            </div>
            <div class="row d-flex justify-content-center">
                <div class="col-4">
