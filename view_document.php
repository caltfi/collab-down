...
<?php
    ...
    //using the doc_id get the document information
    ...
    if (!mysqli_stmt_prepare($prep_stat, $query)) {
        header("Location: view_documents.php?error=stmtfail");
        exit();
    }
        ...
        <div class="row">
            ...
            <div class="col-10">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item text-muted"><?php //echo $total_word_count ?>XXXX words total</li>
                    <li class="list-group-item text-muted"><?php //echo count($users) ?> X users contributed</li>
                    <li class="list-group-item text-muted">Something else</li>
                </ul>
            </div>
            <div class="col-2">
